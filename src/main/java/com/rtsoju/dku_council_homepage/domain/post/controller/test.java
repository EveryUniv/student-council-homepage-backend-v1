...
public class test {
    ...
    public void init(){
        for (int i=0; i<5; i++){
            ...
            postRepository.save(new Petition(findUser.get(), "Petition"+i, "Petition"+i));
            Optional<Petition> findPetition = petitionRepository.findByTitle("Petition"+i);
            commentRepository.save(new Comment(findPetition.get(), findUser.get(), "hi"));
            commentRepository.save(new Comment(findPetition.get(), findUser.get(), "hi"));
