...
public class PetitionController {
    ...
    @GetMapping
    public PageRes<PagePetitionDto> list(@RequestParam(value = "q", required = false)String query, @RequestParam(value = "status", required = false)String status,  Pageable pageable) {
